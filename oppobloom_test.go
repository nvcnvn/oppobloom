...
func TestTheBasics(t *testing.T) {
	...
	f.Forget(twentyNineId)
	shouldNotContain(t, "nothing should be contained at all agin", f, twentyNineId)
	...
	shouldContain(t, "colliding array returns true in second call", f, thirtyThreeId)
